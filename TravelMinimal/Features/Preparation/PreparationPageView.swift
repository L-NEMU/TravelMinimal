...
struct PreparationPageView: View {
    ...
    private var transportSection: some View {
        sectionContainer(title: "Transport") {
            ...
            inputRow("Code", text: $transportCodeInput)
            inputRow("Waiting Point", text: $waitingPointInput)
            inputRow("Seat", text: $seatInput)
            inputRow("Price", text: $transportPriceInput, decimal: true)
    ...
    private var hotelSection: some View {
        sectionContainer(title: "Hotel") {
            inputRow("Name", text: $hotelNameInput)
            inputRow("Price", text: $hotelPriceInput, decimal: true)
    ...
    private var leisureInputSection: some View {
        sectionContainer(title: "Leisure Entry") {
            ...
            inputRow("Title", text: $leisureTitleInput)
            inputRow("Location", text: $leisureLocationInput)
            inputRow("Price", text: $leisurePriceInput, decimal: true)
    ...
    private func inputRow(_ label: String, text: Binding<String>, decimal: Bool = false) -> some View {
        VStack(alignment: .leading, spacing: 6) {
            Text(label)
                .font(.system(size: 13, weight: .medium))
                .foregroundStyle(.secondary)
